...
public class ContactsManager {
	...
	public void addContacts(String name,String path) throws InterruptedException{
		if(name!=null){
			driver.findElement(By.id("contact-list-name")).sendKeys(name);
		}
		driver.findElement(By.id("contact_file")).sendKeys(path);
		Thread.sleep(1000);
	...
	public void gotoContactsUpdate(String name) throws InterruptedException{
		...
		MyAssert.assert_True("不能进入更新企业通讯录界面",driver.getPageSource().contains(WebInfos.contact更新标题));
	}
}
